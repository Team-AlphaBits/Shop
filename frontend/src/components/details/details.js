...
class Details extends Component {
  ...
  render() {
          ...
          <div className={classes.disc}>
            ...
            <p className={classes.oldprc}>
              ...
              <strike>
                ₹{" "}
                {this.discount(
                  this.props.DetailData.productData.price,
                  "oldprice",
                  dis
                )}
              </strike>
            ...
            <button
              ...
              onClick={() =>
                this.AddedtoCart(this.props.DetailData.productData._id, "Add")
              }
            >
              Add to Cart
            </button>
            <button
              ...
              onClick={() =>
                this.AddedtoCart(this.props.DetailData.productData._id, "Buy")
              }
            >
              Buy Now
            </button>
    ...
    if (this.props.error) {
      show = (
        <Modal modalclosed={() => this.props.errorNull()}>
          Some Error Occured...!
        </Modal>
      );
    }
